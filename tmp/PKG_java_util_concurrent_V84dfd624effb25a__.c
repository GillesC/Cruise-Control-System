...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_ConcushMap_5_hash0(jamaica_thread *ct,jamaica_int32 n0) {
 jamaica_int32 tp;
...
l2:
 n0=JAMAICA_ADDS32(n0,((n0<<15)^(-12931)));
 n0=(n0^((n0>>10) &  ((jamaica_int32)4194303)));
 n0=JAMAICA_ADDS32(n0,(n0<<3));
 n0=(n0^((n0>>6) &  ((jamaica_int32)67108863)));
 n0=JAMAICA_ADDS32(n0,JAMAICA_ADDS32((n0<<2),(n0<<14)));
 return (n0^((n0>>16) &  ((jamaica_int32)65535)));
LABEL_tSOE:    jamaica_throwStackOvrflwErr(ct);     return 0;
}
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_ConcushMap_5_segmentFor1(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
...
l2:
 ...
 n0=(((n0>>(JAMAICA_BLOCK_GET_DATA32(r0,6).i&31)) & (((JAMAICA_BLOCK_GET_DATA32(r0,6).i&31)==0)?-1:((((jamaica_int32)1)<<(32-(JAMAICA_BLOCK_GET_DATA32(r0,6).i&31)))-1)))&JAMAICA_BLOCK_GET_DATA32(r0,5).i);
 ...
 n2=(n1&15);
 JAMAICA_GET_REF_ARRAY(r1,n0,r0);
 ct->m.cli-=1;
 return r0;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_ConcushMap_5__00030003e2(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n3,jamaica_float f0,jamaica_int32 n2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL,r3=JAMAICA_NULL,r2=JAMAICA_NULL,r4=JAMAICA_NULL;
 jamaica_int32 n5=0,n4=0,n6=0;
...
{JAMAICA_BLOCK_GET_DATA32(r0,4).r=JAMAICA_NULL;}
 ...
 if (((JAMAICA_NATIVE_MATH_FLOAT_FLOAT_ISNAN(f0)||JAMAICA_NATIVE_MATH_FLOAT_FLOAT_ISNAN(((jamaica_float) 0.0F))||(f0<((jamaica_float) 0.0F)))?-1:((f0==((jamaica_float) 0.0F))?0:+1))<=0) { goto l5; }
 if (n3<0) { goto l5; }
 n4=n2;
 if (n4>0) { goto l6; }
l5:
...
l9:
 ...
 goto l9;
l12:
 JAMAICA_BLOCK_GET_DATA32(r0,6).i = JAMAICA_SUBS32(32,n4);
 JAMAICA_BLOCK_GET_DATA32(r0,5).i = JAMAICA_SUBS32(n6,1);
{ jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12_newArray1;
ct->calledMethod=m;
 r1=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,n6);
}
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r0,7).r,2).r=new_ref;}
 ...
 if (n3<=1073741824) { goto l14; }
 n3=1073741824;
l14:
 if (n5==0) { goto LABEL_tAE; }
 n2=JAMAICA_DIVS32(n3,n5);
 n4=n2;
 if (JAMAICA_MULS32(n2,n5)>=n3) { goto l16; }
 n4=JAMAICA_ADDS32(n2,1);
l16:
 n3=1;
 n2=n4;
l17:
...
l21:
 ...
 if (n2>=((JAMAICA_BLOCK_GET_DATA32(r2,3).i>>4) &  ((jamaica_int32)268435455))) { goto l27; }
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 r3=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_util_concurrent_Concugment_12);
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12__00030003e0;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32,jamaica_float))JAMAICA_BLOCK_GET_P(m,4))(ct,r3,n3,f0);
}
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
 n4=JAMAICA_BLOCK_GET_DATA32(r2,3).i;
 if (((jamaica_uint32)(n2))>=((jamaica_uint32)(((n4>>4) &  ((jamaica_int32)268435455))))) { goto LABEL_tAIOOBE; }
 r4=JAMAICA_BLOCK_GET_R(r2,1);
 r4=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,1).r,2).r;
 if ((r3!=JAMAICA_NULL)&&(r4!=jam_class_java_lang_Object_92)&&((r4==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r3,1),r4)))) { goto LABEL_tASE; }
 n5=(n4&15);
...
{l[3]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r2,n2,r3);
...
l26:
 if (n2<((JAMAICA_BLOCK_GET_DATA32(r2,3).i>>4) &  ((jamaica_int32)268435455))) { goto l24; }
l27:
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_ConcushMap_5_get7(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 ...
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_java_util_concurrent_ConcushMap_5_get7;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
l2:
 ...
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Object_92_hashCode2,1).i>>20) &  ((jamaica_int32)4095));
...
ct->calledMethod=m;
 ...
 n0=jam_comp_java_util_concurrent_ConcushMap_5_hash0(ct,n0);
...
{l[1]=JAMAICA_NULL;}
 ...
 n1=(((n0>>(n1&31)) & (((n1&31)==0)?-1:((((jamaica_int32)1)<<(32-(n1&31)))-1)))&n2);
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
...
{l[0]=JAMAICA_NULL;}
 ...
 r1=jam_comp_java_util_concurrent_Concugment_12_get5(ct,r2,r1,n0);
 ct->f=ct->s[tp-4];
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_ConcushMap_5_put11(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 ...
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_java_util_concurrent_ConcushMap_5_put11;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
ct->calledMethod=m;
 ...
 n0=jam_comp_java_util_concurrent_ConcushMap_5_hash0(ct,n0);
 r3=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r0,7).r,2).r;
 n1=JAMAICA_BLOCK_GET_DATA32(r0,6).i;
...
{l[1]=JAMAICA_NULL;}
 ...
 r2=jam_comp_java_util_concurrent_Concugment_12_put8(ct,r3,r1,n0,r2,0);
 ct->f=ct->s[tp-4];
 ct->m.cl[tp-2]=JAMAICA_NULL;
 ct->m.cli=tp-7;
 return r2;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_ConcuEntry_8__00030003e0(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_ref r2,jamaica_ref r3) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 /* JAMAICA_C_STACK_OVERFLOW not needed for leaf methods */
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r0,5).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r0,5).r=r3;}
#else
{jamaica_ref new_ref=r3;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r0,5).r=new_ref;}
#endif
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_Concugment_12_getFirst3(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_int32 n1=0,n2=0;
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_Concugment_12_get5(jamaica_thread *ct,jamaica_ref r3,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r7=JAMAICA_NULL,r1=JAMAICA_NULL,r4=JAMAICA_NULL,r5=JAMAICA_NULL,r6=JAMAICA_NULL;
 ...
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12_get5;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
l2:
 r4=r3;
 n5=JAMAICA_BLOCK_GET_DATA32(r4,4).i;
 if (n5==0) { goto l23; }
 r4=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,2).r;
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 n5=JAMAICA_BLOCK_GET_DATA32(r4,3).i;
 n6=((n5>>4) &  ((jamaica_int32)268435455));
 n7=(n0&JAMAICA_SUBS32(n6,1));
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 n6=JAMAICA_BLOCK_GET_DATA32(r1,3).i;
 n6=(n6&15);
l5:
...
{jamaica_ref new_ref=r5;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[4]=new_ref;}
 ...
 if (r5==JAMAICA_NULL) { goto l23; }
 if (r5==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r5,4).i!=n0) { goto l13; }
 r6=JAMAICA_BLOCK_GET_DATA32(r5,3).r;
 JAMAICA_GET_REF_ARRAY_D0(r1,n5,r7);
{ jamaica_ref m=r7;
ct->calledMethod=m;
 n7=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,r6);
}
 if (n7==0) { goto l13; }
...
{l[1]=JAMAICA_NULL;}
 ...
 r4=JAMAICA_BLOCK_GET_DATA32(r5,5).r;
 r0=r4;
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12_readVrLock4;
ct->calledMethod=m;
 r3=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3,r5);
}
 ct->f=ct->s[tp-4];
 ct->m.cl[tp-2]=JAMAICA_NULL;
 ct->m.cli=tp-9;
...
{jamaica_ref new_ref=r5;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[4]=new_ref;}
 ...
 if (r5==JAMAICA_NULL) { goto l23; }
 if (r5==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r5,4).i!=n0) { goto l21; }
 r6=JAMAICA_BLOCK_GET_DATA32(r5,3).r;
 if (r0==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_GET_REF_ARRAY(r1,n5,r7);
{ jamaica_ref m=r7;
ct->calledMethod=m;
 n7=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,r6);
}
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_Concugment_12_put8(jamaica_thread *volatile ct,jamaica_ref volatile r3,jamaica_ref volatile r0,jamaica_int32 volatile n0,jamaica_ref volatile r4,jamaica_int32 volatile n5) {
 ...
 jamaica_ref volatile r8=JAMAICA_NULL,r11=JAMAICA_NULL,r1=JAMAICA_NULL,r6=JAMAICA_NULL,r7=JAMAICA_NULL,r9=JAMAICA_NULL,r10=JAMAICA_NULL;
 jamaica_int32 volatile n6=0,n11=0,n12=0,n7=0,n8=0,n9=0,n10=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+12;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ...
 {jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12_put8;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
{jamaica_ref new_ref=r6;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 n7=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_ReenttLock_7_lock2,1).i>>20) &  ((jamaica_int32)4095));
...
ct->calledMethod=m;
 ...
 n6=1;
 n7=JAMAICA_BLOCK_GET_DATA32(r6,4).i;
 n8=JAMAICA_ADDS32(n7,1);
 if (n7<=JAMAICA_BLOCK_GET_DATA32(r6,6).i) { goto l4; }
...
{l[1]=JAMAICA_NULL;}
 ...
 jam_comp_java_util_concurrent_Concugment_12_rehash9(ct,r6);
l4:
...
{l[1]=JAMAICA_NULL;}
 ...
 r6=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r3,7).r,2).r;
 r7=r6;
...
{jamaica_ref new_ref=r7;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 n7=JAMAICA_BLOCK_GET_DATA32(r6,3).i;
 n9=((n7>>4) &  ((jamaica_int32)268435455));
 n10=(n0&JAMAICA_SUBS32(n9,1));
 n11=n10;
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[6]=new_ref;}
 ...
 n9=JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Object_92_equals5,1).i;
 n9=((n9>>20) &  ((jamaica_int32)4095));
 n10=JAMAICA_BLOCK_GET_DATA32(r1,3).i;
 n10=(n10&15);
 if (n10!=0) { goto l11; }
l6:
 r10=r6;
 if (r10==JAMAICA_NULL) { goto l16; }
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r10,4).i!=n7) { goto l9; }
 r10=JAMAICA_BLOCK_GET_DATA32(r10,3).r;
 JAMAICA_GET_REF_ARRAY_D0(r1,n9,r11);
{ jamaica_ref m=r11;
ct->calledMethod=m;
 n12=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r9,r10);
}
 if (n12!=0) { goto l16; }
l9:
 if (r6==JAMAICA_NULL) { goto LABEL_tNPE; }
...
{l[1]=JAMAICA_NULL;}
 ...
 r6=JAMAICA_BLOCK_GET_DATA32(r6,6).r;
...
l11:
 ...
 if (r10==JAMAICA_NULL) { goto l16; }
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r10,4).i!=n7) { goto l14; }
 r10=JAMAICA_BLOCK_GET_DATA32(r10,3).r;
 if (r9==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_GET_REF_ARRAY(r1,n9,r11);
{ jamaica_ref m=r11;
ct->calledMethod=m;
 n12=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r9,r10);
}
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r6,5).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r6,5).r=r4;}
#else
{jamaica_ref new_ref=r4;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r6,5).r=new_ref;}
#endif
...
{jamaica_ref new_ref=r9;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[5]=new_ref;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r3,5).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r3,5).i,1);
 if (ct->plainAlloc) {
  r6 = jamaicaGC_PlainAllocHeadBlock(ct,106);
  if (r6 != JAMAICA_NULL) {
   JAMAICA_BLOCK_GET_R(r6,1)=jam_class_java_util_concurrent_ConcuEntry_8;
  }
 } else {
 r6=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_util_concurrent_ConcuEntry_8);
 }
...
{l[7]=JAMAICA_NULL;}
 ...
 jam_comp_java_util_concurrent_ConcuEntry_8__00030003e0(ct,r6,r0,n0,r8,r4);
 ...
 r8=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r8,7).r,1).r,2).r;
 if ((r6!=JAMAICA_NULL)&&(r8!=jam_class_java_lang_Object_92)&&((r8==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r6,1),r8)))) { goto LABEL_tASE; }
 n0=(n7&15);
...
{l[2]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r7,n11,r6);
 JAMAICA_BLOCK_GET_DATA32(r3,4).i = n8;
l20:
...
{l[1]=JAMAICA_NULL;}
 ...
 n6=0;
 r6=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r3,1),3).r;
 n7=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_ReenttLock_7_unlock5,1).i>>20) &  ((jamaica_int32)4095));
...
l23:
 n6=2;
 n6=0;
 r7=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r3,1),3).r;
 n7=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_ReenttLock_7_unlock5,1).i>>20) &  ((jamaica_int32)4095));
 n8=(JAMAICA_BLOCK_GET_DATA32(r7,3).i&15);
 JAMAICA_GET_REF_ARRAY(r7,n7,r7);
{ jamaica_ref m=r7;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_Concugment_12_rehash9(jamaica_thread *ct,jamaica_ref r9) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r0=JAMAICA_NULL,r1=JAMAICA_NULL,r15=JAMAICA_NULL,r16=JAMAICA_NULL,r6=JAMAICA_NULL,r10=JAMAICA_NULL,r11=JAMAICA_NULL,r12=JAMAICA_NULL,r13=JAMAICA_NULL,r14=JAMAICA_NULL,r17=JAMAICA_NULL,r18=JAMAICA_NULL,r19=JAMAICA_NULL,r20=JAMAICA_NULL;
 jamaica_int32 n0=0,n15=0,n19=0,n1=0,n2=0,n5=0,n6=0,n8=0,n9=0,n12=0,n13=0,n14=0,n16=0,n17=0,n18=0;
 jamaica_ref b6=JAMAICA_NULL;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+12;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ct->m.cli = tp;
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=l[0];if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}l[0]=r9;}
#else
{jamaica_ref new_ref=r9;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
#endif
...
{jamaica_ref new_ref=r10;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 r11=JAMAICA_BLOCK_GET_DATA32(b6,2).r;
 r0=r11;
...
{jamaica_ref new_ref=r0;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[3]=new_ref;}
 ...
 n14=JAMAICA_BLOCK_GET_DATA32(r11,3).i;
 n14=((n14>>4) &  ((jamaica_int32)268435455));
 n0=n14;
 if (n14<1073741824) { goto l4; }
...
{l[0]=JAMAICA_NULL;}
 ...
 return;
l4:
{ jamaica_ref m=jam_mtd_java_util_concurrent_ConcuEntry_8_newArray1;
ct->calledMethod=m;
 r11=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,(n14<<1));
}
 r1=r11;
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[4]=new_ref;}
 ...
 if (r11==JAMAICA_NULL) { goto LABEL_tNPE; }
 n14=((JAMAICA_BLOCK_GET_DATA32(r11,3).i>>4) &  ((jamaica_int32)268435455));
...
{l[1]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r10,6).i = JAMAICA_CAST_DOUBLE_TO_INTEGER((jamaica_double)JAMAICA_NATIVE_MATH_FLOAT_FLOAT_MUL(((jamaica_float)n14),JAMAICA_BLOCK_GET_DATA32(b6,3).f));
 n14=JAMAICA_SUBS32(n14,1);
 n15=0;
 n2=0;
 n1=0;
 n6=0;
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=l[2];if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}l[2]=r11;}
#else
{jamaica_ref new_ref=r11;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
#endif
...
{l[1]=JAMAICA_NULL;}
 ...
 n5=JAMAICA_BLOCK_GET_DATA32(r12,3).i;
 n6=((n5>>4) &  ((jamaica_int32)268435455));
 r10=JAMAICA_BLOCK_GET_R(r12,1);
 b6=JAMAICA_BLOCK_GET_DATA32(r10,7).r;
 b6=JAMAICA_BLOCK_GET_DATA32(b6,1).r;
 r10=JAMAICA_BLOCK_GET_DATA32(b6,2).r;
...
{l[2]=JAMAICA_NULL;}
 ...
 n8=JAMAICA_BLOCK_GET_DATA32(r13,3).i;
 n9=((n8>>4) &  ((jamaica_int32)268435455));
 r11=JAMAICA_BLOCK_GET_R(r13,1);
...
{l[5]=JAMAICA_NULL;}
 ...
 n14=JAMAICA_BLOCK_GET_DATA32(r14,3).i;
 n12=((n14>>4) &  ((jamaica_int32)268435455));
 n13=(n14&15);
 r6=JAMAICA_BLOCK_GET_R(r14,1);
...
{jamaica_ref new_ref=r6;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[5]=new_ref;}
 ...
 if (r12==JAMAICA_NULL) { goto l34; }
 if (r13==JAMAICA_NULL) { goto l34; }
 if (n1!=0) { goto l34; }
 if (n5!=0) { goto l34; }
 if (n8!=0) { goto l34; }
 if (n13!=0) { goto l34; }
l18:
 if (n15>=n0) { goto l50; }
 n14=n15;
 if (((jamaica_uint32)(n14))>=((jamaica_uint32)(n2))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_REF_ARRAY_D0(r0,n14,r15);
 r16=r15;
 if (r15==JAMAICA_NULL) { goto l32; }
 if (r15==JAMAICA_NULL) { goto LABEL_tNPE; }
 r17=JAMAICA_BLOCK_GET_DATA32(r15,6).r;
 n14=JAMAICA_BLOCK_GET_DATA32(r15,4).i;
 n14=(n14&n16);
 n19=n14;
 if (r17!=JAMAICA_NULL) { goto l22; }
 if (((jamaica_uint32)(n19))>=((jamaica_uint32)(n6))) { goto LABEL_tAIOOBE; }
 if ((r16!=JAMAICA_NULL)&&(r10!=jam_class_java_lang_Object_92)&&((r10==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r16,1),r10)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY_D0(ct,r12,n19,r16);
 goto l32;
l22:
...
l23:
 if (r17==JAMAICA_NULL) { goto l28; }
 r18=r17;
 if (r18==JAMAICA_NULL) { goto LABEL_tNPE; }
 n19=JAMAICA_BLOCK_GET_DATA32(r18,4).i;
 n19=(n19&n17);
 if (n19==n14) { goto l26; }
...
l26:
 ...
 r17=JAMAICA_BLOCK_GET_DATA32(r17,6).r;
 if (ct->state==JAMAICA_THREAD_STATE_RUNNING) { goto l23; }
 
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=l[10];if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}l[10]=r16;}
#else
{jamaica_ref new_ref=r16;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[10]=new_ref;}
#endif
...
{l[10]=JAMAICA_NULL;}
 ...
 goto l23;
l28:
 if (((jamaica_uint32)(n14))>=((jamaica_uint32)(n9))) { goto LABEL_tAIOOBE; }
 if ((r15!=JAMAICA_NULL)&&(r11!=jam_class_java_lang_Object_92)&&((r11==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r15,1),r11)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY_D0(ct,r13,n14,r15);
 r17=r16;
l29:
 r16=r17;
...
{jamaica_ref new_ref=r16;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[10]=new_ref;}
 ...
 n14=JAMAICA_BLOCK_GET_DATA32(r16,4).i;
 n19=(n14&n18);
 if (((jamaica_uint32)(n19))>=((jamaica_uint32)(n12))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_REF_ARRAY_D0(r14,n19,r17);
...
{jamaica_ref new_ref=r17;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[11]=new_ref;}
 ...
 if (ct->plainAlloc) {
  r18 = jamaicaGC_PlainAllocHeadBlock(ct,106);
  if (r18 != JAMAICA_NULL) {
   JAMAICA_BLOCK_GET_R(r18,1)=jam_class_java_util_concurrent_ConcuEntry_8;
  }
 } else {
 r18=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_util_concurrent_ConcuEntry_8);
 }
 if (r18==JAMAICA_NULL) { goto LABEL_tOOME; }
 r19=JAMAICA_BLOCK_GET_DATA32(r16,3).r;
 r20=JAMAICA_BLOCK_GET_DATA32(r16,5).r;
 
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r18,3).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r18,3).r=r19;}
#else
{jamaica_ref new_ref=r19;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r18,3).r=new_ref;}
#endif

 JAMAICA_BLOCK_GET_DATA32(r18,4).i = n14;
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r18,6).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r18,6).r=r17;}
#else
{jamaica_ref new_ref=r17;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r18,6).r=new_ref;}
#endif

 
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r18,5).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r18,5).r=r20;}
#else
{jamaica_ref new_ref=r20;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r18,5).r=new_ref;}
#endif

 if ((r18!=JAMAICA_NULL)&&(r6!=jam_class_java_lang_Object_92)&&((r6==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r18,1),r6)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY_D0(ct,r14,n19,r18);
...
{l[10]=JAMAICA_NULL;}
 ...
 r17=JAMAICA_BLOCK_GET_DATA32(r16,6).r;
...
l34:
 ...
 if (r0==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (((jamaica_uint32)(n14))>=((jamaica_uint32)(n2))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_REF_ARRAY(r0,n14,r15);
 r16=r15;
 if (r15==JAMAICA_NULL) { goto l48; }
 if (r15==JAMAICA_NULL) { goto LABEL_tNPE; }
 r17=JAMAICA_BLOCK_GET_DATA32(r15,6).r;
 n14=JAMAICA_BLOCK_GET_DATA32(r15,4).i;
 n14=(n14&n16);
 n19=n14;
 if (r17!=JAMAICA_NULL) { goto l38; }
 if (r12==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (((jamaica_uint32)(n19))>=((jamaica_uint32)(n6))) { goto LABEL_tAIOOBE; }
 if ((r16!=JAMAICA_NULL)&&(r10!=jam_class_java_lang_Object_92)&&((r10==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r16,1),r10)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY(ct,r12,n19,r16);
 goto l48;
l38:
...
l44:
 ...
 if (((jamaica_uint32)(n14))>=((jamaica_uint32)(n9))) { goto LABEL_tAIOOBE; }
 if ((r15!=JAMAICA_NULL)&&(r11!=jam_class_java_lang_Object_92)&&((r11==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r15,1),r11)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY(ct,r13,n14,r15);
 r17=r16;
l45:
 r16=r17;
...
{jamaica_ref new_ref=r16;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[10]=new_ref;}
 ...
 if (((jamaica_uint32)(n19))>=((jamaica_uint32)(n12))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_REF_ARRAY(r14,n19,r17);
...
{jamaica_ref new_ref=r20;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r18,5).r=new_ref;}
 ...
 if ((r18!=JAMAICA_NULL)&&(r6!=jam_class_java_lang_Object_92)&&((r6==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r18,1),r6)))) { goto LABEL_tASE; }
 JAMAICA_SET_REF_ARRAY(ct,r14,n19,r18);
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r9,7).r,2).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r9,7).r,2).r=r1;}
#else
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r9,7).r,2).r=new_ref;}
#endif
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_Concugment_12_remove10(jamaica_thread *volatile ct,jamaica_ref volatile r4,jamaica_ref volatile r1,jamaica_int32 volatile n0,jamaica_ref volatile r5) {
 jamaica_int32 volatile tp;
 jamaica_native_longjump u;
 jamaica_GCEnv *volatile gc = ct->m.gcenv;
 jamaica_ref *volatile l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref volatile r8=JAMAICA_NULL,r9=JAMAICA_NULL,r11=JAMAICA_NULL,r2=JAMAICA_NULL,r7=JAMAICA_NULL,r10=JAMAICA_NULL;
 jamaica_int32 volatile n5=0,n10=0,n6=0,n7=0,n8=0,n9=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+12;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 if (JAMAICA_NATIVE_ON_LONGJUMP(u)) {
 ...
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=JAMAICA_LONG_JUMP_BUF_TO_INDEX(ct,&u);
 {jamaica_ref m=jam_mtd_java_util_concurrent_Concugment_12_remove10;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
l2:
 ...
 n6=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_ReenttLock_7_lock2,1).i>>20) &  ((jamaica_int32)4095));
...
ct->calledMethod=m;
 ...
 n5=1;
 n6=JAMAICA_BLOCK_GET_DATA32(r4,4).i;
 n6=JAMAICA_SUBS32(n6,1);
 r7=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,2).r;
 r8=r7;
...
{jamaica_ref new_ref=r8;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 n9=(n0&JAMAICA_SUBS32(n8,1));
 n10=n9;
 if (((jamaica_uint32)(n9))>=((jamaica_uint32)(n8))) { goto LABEL_tAIOOBE; }
 n7=(n7&15);
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[4]=new_ref;}
 ...
 n7=JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Object_92_equals5,1).i;
...
l4:
 r10=r7;
 if (r10==JAMAICA_NULL) { goto l14; }
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r10,4).i!=n0) { goto l7; }
 r10=JAMAICA_BLOCK_GET_DATA32(r10,3).r;
 JAMAICA_GET_REF_ARRAY_D0(r2,n7,r11);
{ jamaica_ref m=r11;
ct->calledMethod=m;
 n9=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,r10);
}
 if (n9!=0) { goto l14; }
l7:
 if (r7==JAMAICA_NULL) { goto LABEL_tNPE; }
...
{l[1]=JAMAICA_NULL;}
 ...
 r7=JAMAICA_BLOCK_GET_DATA32(r7,6).r;
...
l9:
 ...
 if (r10==JAMAICA_NULL) { goto l14; }
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (JAMAICA_BLOCK_GET_DATA32(r10,4).i!=n0) { goto l12; }
 r10=JAMAICA_BLOCK_GET_DATA32(r10,3).r;
 if (r1==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_GET_REF_ARRAY(r2,n7,r11);
{ jamaica_ref m=r11;
ct->calledMethod=m;
 n9=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,r10);
}
...
{jamaica_ref new_ref=r10;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[6]=new_ref;}
 ...
 if (r5==JAMAICA_NULL) { goto LABEL_tNPE; }
 r11=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r5,1),3).r;
 n7=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Object_92_equals5,1).i>>20) &  ((jamaica_int32)4095));
 n0=(JAMAICA_BLOCK_GET_DATA32(r11,3).i&15);
...
{ jamaica_ref m=r11;
ct->calledMethod=m;
 n7=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r5,r2);
}
 if (n7==0) { goto l22; }
l17:
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[5]=new_ref;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r4,5).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r4,5).i,1);
 if (r7==JAMAICA_NULL) { goto LABEL_tNPE; }
 r2=JAMAICA_BLOCK_GET_DATA32(r7,6).r;
...
l18:
 if (r9==r7) { goto l21; }
 if (ct->plainAlloc) {
  r10 = jamaicaGC_PlainAllocHeadBlock(ct,106);
  if (r10 != JAMAICA_NULL) {
   JAMAICA_BLOCK_GET_R(r10,1)=jam_class_java_util_concurrent_ConcuEntry_8;
  }
 } else {
 r10=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_util_concurrent_ConcuEntry_8);
 }
...
{jamaica_ref new_ref=r10;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[6]=new_ref;}
 ...
 if (r9==JAMAICA_NULL) { goto LABEL_tNPE; }
 r11=JAMAICA_BLOCK_GET_DATA32(r9,3).r;
 n7=JAMAICA_BLOCK_GET_DATA32(r9,4).i;
 r5=JAMAICA_BLOCK_GET_DATA32(r9,5).r;
...
{l[4]=JAMAICA_NULL;}
 ...
 jam_comp_java_util_concurrent_ConcuEntry_8__00030003e0(ct,r10,r11,n7,r2,r5);
...
{l[3]=JAMAICA_NULL;}
 ...
 r9=JAMAICA_BLOCK_GET_DATA32(r9,6).r;
...
{l[1]=JAMAICA_NULL;}
 ...
 if (((jamaica_uint32)(n10))>=((jamaica_uint32)(((n7>>4) &  ((jamaica_int32)268435455))))) { goto LABEL_tAIOOBE; }
 r7=JAMAICA_BLOCK_GET_R(r8,1);
 r7=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r7,7).r,1).r,2).r;
 if ((r2!=JAMAICA_NULL)&&(r7!=jam_class_java_lang_Object_92)&&((r7==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r2,1),r7)))) { goto LABEL_tASE; }
 n0=(n7&15);
...
{l[4]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r8,n10,r2);
 JAMAICA_BLOCK_GET_DATA32(r4,4).i = n6;
l22:
...
{l[1]=JAMAICA_NULL;}
 ...
 n5=0;
 r7=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r4,1),3).r;
 n6=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_ReenttLock_7_unlock5,1).i>>20) &  ((jamaica_int32)4095));
 n7=(JAMAICA_BLOCK_GET_DATA32(r7,3).i&15);
 JAMAICA_GET_REF_ARRAY(r7,n6,r7);
{ jamaica_ref m=r7;
ct->calledMethod=m;
