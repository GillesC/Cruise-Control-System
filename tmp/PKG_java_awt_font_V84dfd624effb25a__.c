...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_awt_font_FontRntext_1_equals9(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
...
l6:
 ...
 if (((jamaica_int32)JAMAICA_BLOCK_GET_DATA32(r3,6).b[0])!=0) { goto l17; }
 if (((jamaica_int32)JAMAICA_BLOCK_GET_DATA32(r2,6).b[0])!=0) { goto l17; }
...
{l[0]=JAMAICA_NULL;}
 ...
 if (JAMAICA_BLOCK_GET_DATA32(r3,4).r!=JAMAICA_BLOCK_GET_DATA32(r2,4).r) { goto l16; }
 if (JAMAICA_BLOCK_GET_DATA32(r3,5).r!=JAMAICA_BLOCK_GET_DATA32(r2,5).r) { goto l16; }
...
{l[2]=JAMAICA_NULL;}
 ...
 if (JAMAICA_BLOCK_GET_DATA32(r1,3).r!=JAMAICA_NULL) { goto l13; }
 n0=1;
 goto l15;
l13:
 n0=0;
...
{l[2]=JAMAICA_NULL;}
 ...
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_awt_geom_Affinsform_0_equals50,1).i>>20) &  ((jamaica_int32)4095));
 n1=(JAMAICA_BLOCK_GET_DATA32(r1,3).i&15);
 JAMAICA_GET_REF_ARRAY(r1,n0,r1);
{ jamaica_ref m=r1;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,r2);
}
l15:
 ct->m.cli-=5;
 return n0;
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_awt_font_FontRntext_1_getAngHint6,1).i>>20) &  ((jamaica_int32)4095));
...
{ jamaica_ref m=r5;
ct->calledMethod=m;
 r5=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0);
}
...
{l[3]=JAMAICA_NULL;}
 ...
 if (r3!=r5) { goto l21; }
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_awt_font_FontRntext_1_getFrsHint7,1).i>>20) &  ((jamaica_int32)4095));
 JAMAICA_GET_REF_ARRAY(r2,n0,r3);
{ jamaica_ref m=r3;
ct->calledMethod=m;
 r3=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r1);
...
{l[3]=JAMAICA_NULL;}
 ...
 if (r3!=r5) { goto l21; }
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_awt_font_FontRntext_1_getTrsform3,1).i>>20) &  ((jamaica_int32)4095));
...
{l[4]=JAMAICA_NULL;}
 ...
 JAMAICA_GET_REF_ARRAY(r4,n0,r1);
...
{ jamaica_ref m=r1;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r0);
}
 if (n0==0) { goto l21; }
 n0=1;
 goto l22;
