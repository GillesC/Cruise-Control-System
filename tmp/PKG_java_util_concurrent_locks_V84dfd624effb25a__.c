...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_0_setExhread1(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_0_getExhread2(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 /* JAMAICA_C_STACK_OVERFLOW not needed for leaf methods */
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_1_getState1(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_int32 n0=0;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_1_setState2(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 /* JAMAICA_C_STACK_OVERFLOW not needed for leaf methods */
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_1_compaState3(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0,jamaica_int32 n1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 r1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_locks_Abstrnizer_1_unsafe4,7).r,4).r;
 j0=JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_Abstrnizer_1_stateffset5,4).l;
 if (r1==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_compaapInt71;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_int32,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,r0,j0,n0,n1);
}
 ct->m.cli-=1;
 return n0;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_locks_Abstrnizer_1_release20(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL;
...
l2:
 ...
 n1=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_Abstrnizer_1_tryRelease15,1).i>>20) &  ((jamaica_int32)4095));
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_unparessor7;
ct->calledMethod=m;
...
JBIEXPORT jamaica_int64 JBICALL jam_comp_java_util_concurrent_locks_Abstrbject_2_awaitNanos10(jamaica_thread *ct,jamaica_ref r0,jamaica_int64 j0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
{jamaica_ref new_ref=r0;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 jamaicaScheduler_syncPointFull(ct);
l2:
 r2=Jam_java_lang_Thread_currentThread(ct);
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
 ...
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Thread_157_checkopped64,1).i>>20) &  ((jamaica_int32)4095));
...
{l[0]=JAMAICA_NULL;}
 ...
 n0=Jam_java_lang_Thread_interrupted0(ct,r2,1);
 if (n0==0) { goto l4; }
...
{l[2]=JAMAICA_NULL;}
 ...
 r2=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_lang_Interption_74);
...
{ jamaica_ref m=jam_mtd_java_lang_Interption_74__00030003e0;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2);
}
...
l4:
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrbject_2_addCoaiter1;
ct->calledMethod=m;
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_fullylease29;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r4,r2);
}
{ jamaica_ref m=jam_mtd_java_lang_System_146_nanoTime33;
ct->calledMethod=m;
 j1=((jamaica_int64(JBICALL *)(jamaica_thread *))JAMAICA_BLOCK_GET_P(m,4))(ct);
}
 n1=0;
 r2=r0;
...
{jamaica_ref new_ref=r6;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[5]=new_ref;}
 ...
 b0=JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_locks_LockSpport_6_unsafe0,7).r;
 r7=r0;
...
l5:
 r9=JAMAICA_BLOCK_GET_DATA32(r2,5).r;
 if (r9==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_isOnSQueue25;
ct->calledMethod=m;
 n2=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r9,r4);
}
 if (n2!=0) { goto l13; }
 j2=j0;
 n2=(JAMAICA_GT_S64(j2,JAMAICA_INT64_CONST_0) ?+1:(JAMAICA_EQ_S64(j2,JAMAICA_INT64_CONST_0)?0:-1));
 if (n2>0) { goto l8; }
...
{l[4]=JAMAICA_NULL;}
 ...
 r2=JAMAICA_BLOCK_GET_DATA32(r5,5).r;
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_transdWait28;
ct->calledMethod=m;
 n2=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r6);
}
 goto l13;
l8:
 n1=JAMAICA_BLOCK_GET_DATA32(jam_class_java_util_concurrent_locks_LockSpport_6,5).i;
 if (((n1>>20) |  ((n1>=0)?0:(jamaica_int32)(-4096)))!=6) {
  jamaicaInterpreter_initialize_class_helper(ct,jam_class_java_util_concurrent_locks_LockSpport_6,-1);
 }
 if (n2<=0) { goto l10; }
...
{jamaica_ref new_ref=r9;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[8]=new_ref;}
 ...
 r10=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_putObject6;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r10,r9,JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_LockSpport_6_parkBffset1,4).l,r2);
}
 r10=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
 if (r10==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_park92;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32,jamaica_int64))JAMAICA_BLOCK_GET_P(m,4))(ct,r10,0,j2);
}
 r10=JAMAICA_NULL;
 r11=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
...
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_putObject6;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r11,r9,JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_LockSpport_6_parkBffset1,4).l,r10);
}
l10:
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrbject_2_checkiting7;
ct->calledMethod=m;
 n2=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r7,r8);
}
 n1=n2;
 if (n2!=0) { goto l13; }
{ jamaica_ref m=jam_mtd_java_lang_System_146_nanoTime33;
ct->calledMethod=m;
 j2=((jamaica_int64(JBICALL *)(jamaica_thread *))JAMAICA_BLOCK_GET_P(m,4))(ct);
}
 j0=JAMAICA_SUBS64(j0,JAMAICA_SUBS64(j2,j1));
 j1=j2;
...
{l[0]=JAMAICA_NULL;}
 ...
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_acquiueued12;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r3,n0);
}
 if (n0==0) { goto l16; }
 if (n1==(-1)) { goto l16; }
 n1=1;
...
{l[1]=JAMAICA_NULL;}
 ...
 if (JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r3,7).r,2).r==JAMAICA_NULL) { goto l18; }
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrbject_2_unliniters4;
ct->calledMethod=m;
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrbject_2_reporrWait8;
ct->calledMethod=m;
...
ct->calledMethod=m;
 ...
 ct->m.cli-=9;
 return JAMAICA_SUBS64(j0,JAMAICA_SUBS64(j2,j1));
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_LockSpport_6_setBlocker0(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 r2=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_locks_LockSpport_6_unsafe0,7).r,4).r;
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_putObject6;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r0,JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_LockSpport_6_parkBffset1,4).l,r1);
}
 ct->m.cli-=2;
 return;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_LockSpport_6_parkNanos3(jamaica_thread *ct,jamaica_ref r0,jamaica_int64 j0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_putObject6;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r1,JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_LockSpport_6_parkBffset1,4).l,r0);
}
 r0=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
 if (r0==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_park92;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32,jamaica_int64))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,0,j0);
}
 r0=JAMAICA_NULL;
 r2=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_ReenttLock_7_lock2(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL;
...
l2:
 ...
 if (r0==JAMAICA_NULL) { goto LABEL_tNPE; }
 r1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r0,1),3).r;
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_concurrent_locks_Reent4Sync_10_lock1,1).i>>20) &  ((jamaica_int32)4095));
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_ReenttLock_7_unlock5(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL,r2=JAMAICA_NULL;
...
ct->calledMethod=m;
 ...
 if (n0==0) { goto l7; }
 if (r1==JAMAICA_NULL) { goto LABEL_tNPE; }
 r0=JAMAICA_BLOCK_GET_DATA32(r1,4).r;
...
JBIEXPORT void JBICALL jam_comp_java_util_concurrent_locks_ReentrSync_9_lock1(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL,r2=JAMAICA_NULL;
...
{jamaica_ref new_ref=r1;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 n0=0;
 n1=1;
 r2=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_locks_Abstrnizer_1_unsafe4,7).r,4).r;
 j0=JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_Abstrnizer_1_stateffset5,4).l;
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_compaapInt71;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_int32,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r1,j0,n0,n1);
}
 if (n0==0) { goto l4; }
...
{ jamaica_ref m=jam_mtd_java_util_concurrent_locks_Abstrnizer_1_acquire18;
ct->calledMethod=m;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_locks_Reent4Sync_10_nonfaquire2(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
 ...
 r3=r0;
 n1=JAMAICA_BLOCK_GET_DATA32(r3,6).i;
 if (n1!=0) { goto l5; }
 n1=0;
 r1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_locks_Abstrnizer_1_unsafe4,7).r,4).r;
 j0=JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_locks_Abstrnizer_1_stateffset5,4).l;
...
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_compaapInt71;
ct->calledMethod=m;
 n1=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_int32,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,r0,j0,n1,n0);
}
 if (n1==0) { goto l9; }
...
{l[0]=JAMAICA_NULL;}
 ...
 if (n1>=0) { goto l8; }
 r1=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_lang_Error_55);
...
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,jam_str_java_util_concurrent_locks_Reent4Sync_108);
}
...
l8:
 JAMAICA_BLOCK_GET_DATA32(r3,6).i = n1;
 ct->m.cli-=2;
 return 1;
l9:
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_locks_Reent4Sync_10_tryRelease3(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r2=JAMAICA_NULL,r1=JAMAICA_NULL,r3=JAMAICA_NULL;
 jamaica_int32 n2=0,n1=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+2;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ct->m.cli = tp;
...
{l[0]=JAMAICA_NULL;}
 ...
 r0=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_lang_Illegption_63);
...
{ jamaica_ref m=jam_mtd_java_lang_Illegption_63__00030003e0;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0);
}
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r1,3).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r1,3).r=r2;}
#else
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r1,3).r=new_ref;}
#endif
