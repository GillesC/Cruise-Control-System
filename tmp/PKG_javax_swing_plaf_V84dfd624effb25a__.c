...
JBIEXPORT jamaica_int32 JBICALL jam_comp_javax_swing_plaf_CompoentUI_11_contains8(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_int32 n1) {
 jamaica_int32 tp;
...
l2:
 ...
 n2=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_awt_Component_25_inside150,1).i>>20) &  ((jamaica_int32)4095));
 n3=(JAMAICA_BLOCK_GET_DATA32(r2,3).i&15);
 JAMAICA_GET_REF_ARRAY(r2,n2,r2);
{ jamaica_ref m=r2;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,n0,n1);
}
 ct->m.cli-=1;
 return n0;
