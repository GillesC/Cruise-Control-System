...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_logging_Level_5_intValue4(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
...
JBIEXPORT void JBICALL jam_comp_java_util_logging_Logger_16_finest21(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
{jamaica_ref new_ref=r0;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
 ...
 jamaicaScheduler_syncPointFull(ct);
l2:
 n0=JAMAICA_BLOCK_GET_DATA32(jam_class_java_util_logging_Level_5,5).i;
 if (((n0>>20) |  ((n0>=0)?0:(jamaica_int32)(-4096)))!=6) {
  jamaicaInterpreter_initialize_class_helper(ct,jam_class_java_util_logging_Level_5,-1);
 }
 b0=JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_logging_Level_5_FINEST12,7).r;
 r2=JAMAICA_BLOCK_GET_DATA32(b0,4).r;
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
 n0=JAMAICA_BLOCK_GET_DATA32(r2,4).i;
 n1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r0,7).r,1).r,2).i;
 if (n0>=n1) { goto l4; }
...
l4:
 ...
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_logging_Logger_16_log9,1).i>>20) &  ((jamaica_int32)4095));
...
{ jamaica_ref m=r2;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,JAMAICA_BLOCK_GET_DATA32(b0,4).r,r1);
}
 ct->m.cli-=2;
 return;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_logging_Logger_16_isLoggable24(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_int32 n0=0,n1=0;
...
l2:
 ...
 n0=JAMAICA_BLOCK_GET_DATA32(r1,4).i;
 ...
 if (n0!=JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_logging_Logger_16_offValue1,4).i) { goto l5; }
l4:
 ct->m.cli-=2;
 return 0;
l5:
