...
JBIEXPORT jamaica_ref JBICALL jam_comp_org_xml_sax_helpers_AttrisImpl_0_getValue6(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
...
l2:
 if (n0<0) { goto l5; }
 if (n0>=JAMAICA_BLOCK_GET_DATA32(r0,3).i) { goto l5; }
 r0=JAMAICA_BLOCK_GET_DATA32(r0,4).r;
 n0=JAMAICA_ADDS32(JAMAICA_MULS32(n0,5),4);
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_org_xml_sax_helpers_AttrisImpl_0_getIndex8(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
{jamaica_ref new_ref=r0;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
 ...
 jamaicaScheduler_syncPointFull(ct);
l2:
 n0=JAMAICA_MULS32(JAMAICA_BLOCK_GET_DATA32(r0,3).i,5);
 n1=0;
l3:
 if (n1>=n0) { goto l8; }
 r2=JAMAICA_BLOCK_GET_DATA32(r0,4).r;
 n2=n1;
 n3=JAMAICA_ADDS32(n2,2);
...
ct->calledMethod=m;
 n3=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,r1);
}
 if (n3==0) { goto l6; }
...
{l[0]=JAMAICA_NULL;}
 ...
 ct->m.cli-=2;
 return JAMAICA_DIVS32(n1,5);
l6:
 n1=JAMAICA_ADDS32(n2,5);
...
JBIEXPORT void JBICALL jam_comp_org_xml_sax_helpers_AttrisImpl_0_clear9(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL,r2=JAMAICA_NULL,r4=JAMAICA_NULL;
 jamaica_int32 n5=0,n0=0,n2=0,n3=0;
...
l2:
 if (JAMAICA_BLOCK_GET_DATA32(r0,4).r==JAMAICA_NULL) { goto l11; }
 n5=0;
 r4=r0;
 n3=0;
 r2=JAMAICA_NULL;
 ...
 n0=JAMAICA_MULS32(n0,5);
 r1=JAMAICA_BLOCK_GET_DATA32(r4,4).r;
...
l5:
 ...
 JAMAICA_SET_REF_ARRAY_D0(ct,r1,n5,JAMAICA_NULL);
...
l8:
 ...
 if (((jamaica_uint32)(n5))>=((jamaica_uint32)(n3))) { goto LABEL_tAIOOBE; }
 JAMAICA_SET_REF_ARRAY(ct,r1,n5,JAMAICA_NULL);
 n5=JAMAICA_ADDS32(n5,1);
...
JBIEXPORT void JBICALL jam_comp_org_xml_sax_helpers_AttrisImpl_0_addAtibute10(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_ref r2,jamaica_ref r3,jamaica_ref r4,jamaica_ref r5) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r7=JAMAICA_NULL,r8=JAMAICA_NULL,r6=JAMAICA_NULL,r9=JAMAICA_NULL;
 jamaica_int32 n0=0,n2=0,n3=0,n4=0,n5=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+8;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ct->m.cli = tp;
...
{jamaica_ref new_ref=r7;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 n0=n2;
 if (n2<=0) { goto l15; }
 r6=JAMAICA_BLOCK_GET_DATA32(r6,4).r;
 if (r6==JAMAICA_NULL) { goto l5; }
...
l5:
 ...
 goto l8;
l6:
 if (n3>=JAMAICA_MULS32(n2,5)) { goto l15; }
 n2=n3;
l8:
 n0=JAMAICA_MULS32(n0,5);
l9:
...
l12:
 ...
 r6=jamaicaInterpreter_allocSimpleArray(ct,n3,jam_typ_arr1_java_lang_String_134);
 r8=r6;
...
{jamaica_ref new_ref=r8;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 if (n2<=0) { goto l14; }
 Jam_java_lang_System_arraycopy(ct,JAMAICA_BLOCK_GET_DATA32(r9,4).r,0,r6,0,JAMAICA_MULS32(n2,5));
l14:
...
{l[1]=JAMAICA_NULL;}
 ...
 if ((r1!=JAMAICA_NULL)&&(r7!=jam_class_java_lang_Object_92)&&((r7==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r1,1),r7)))) { goto LABEL_tASE; }
 n3=(n3&15);
...
{l[3]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r6,n0,r1);
 n5=JAMAICA_ADDS32(n0,1);
...
{l[4]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r6,n5,r2);
 n5=JAMAICA_ADDS32(n0,2);
 if (((jamaica_uint32)(n5))>=((jamaica_uint32)(n4))) { goto LABEL_tAIOOBE; }
 if ((r3!=JAMAICA_NULL)&&(r7!=jam_class_java_lang_Object_92)&&((r7==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r3,1),r7)))) { goto LABEL_tASE; }
...
{l[5]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r6,n5,r3);
 n5=JAMAICA_ADDS32(n0,3);
 if (((jamaica_uint32)(n5))>=((jamaica_uint32)(n4))) { goto LABEL_tAIOOBE; }
 if ((r4!=JAMAICA_NULL)&&(r7!=jam_class_java_lang_Object_92)&&((r7==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r4,1),r7)))) { goto LABEL_tASE; }
...
{l[6]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r6,n5,r4);
 n0=JAMAICA_ADDS32(n0,4);
 if (((jamaica_uint32)(n0))>=((jamaica_uint32)(n4))) { goto LABEL_tAIOOBE; }
 if ((r5!=JAMAICA_NULL)&&(r7!=jam_class_java_lang_Object_92)&&((r7==JAMAICA_NULL) || (!jamaicaClasses_compatibleClass(ct,JAMAICA_BLOCK_GET_R(r5,1),r7)))) { goto LABEL_tASE; }
...
{l[7]=JAMAICA_NULL;}
 ...
 JAMAICA_SET_REF_ARRAY(ct,r6,n0,r5);
...
{l[0]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r0,3).i = JAMAICA_ADDS32(n2,1);
 ct->m.cli-=8;
 return;
...
JBIEXPORT void JBICALL jam_comp_org_xml_sax_helpers_AttrisImpl_0_ensuracity12(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l6:
 ...
 goto l10;
l7:
 if (n3<JAMAICA_MULS32(n2,5)) { goto l9; }
...
l14:
 if ((n3<0)) { goto LABEL_tNASE; }
 r1=jamaicaInterpreter_allocSimpleArray(ct,n3,jam_typ_arr1_java_lang_String_134);
 r2=r1;
...
{jamaica_ref new_ref=r2;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 if (n0<=0) { goto l16; }
 Jam_java_lang_System_arraycopy(ct,JAMAICA_BLOCK_GET_DATA32(r3,4).r,0,r1,0,JAMAICA_MULS32(n0,5));
l16:
