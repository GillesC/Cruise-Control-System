...
JBIEXPORT void JBICALL jam_comp_javax_xml_namespace_QName_1__00030003e0(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_ref r2,jamaica_ref r3) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r4=JAMAICA_NULL;
...
#ifdef JAMAICA_PARALLEL
{jamaica_ref old_ref=JAMAICA_BLOCK_GET_DATA32(r0,3).r;if(old_ref!=JAMAICA_NULL){jamaica_cpu *cpu=ct->cpu;jamaica_ref white=cpu->gc.white;if(JAMAICA_BLOCK_GET_R(old_ref,0)==white){jamaica_ref gL, result; gL=cpu->gc.greyList;JAMAICA_NATIVE_THREAD_COMPARE_AND_SWAP_REF(&(JAMAICA_BLOCK_GET_R(old_ref,0)),white,gL,result);if(result==white){cpu->gc.greyList=old_ref;}}}JAMAICA_BLOCK_GET_DATA32(r0,3).r=jam_str_javax_xml_namespace_QName_11;}
#else
{jamaica_ref new_ref=jam_str_javax_xml_namespace_QName_11;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}JAMAICA_BLOCK_GET_DATA32(r0,3).r=new_ref;}
#endif
...
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,jam_str_javax_xml_namespace_QName_16);
}
...
{ jamaica_ref m=jam_mtd_java_lang_Illegption_62__00030003e1;
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,jam_str_javax_xml_namespace_QName_19);
}
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_javax_xml_namespace_QName_1_equals5(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 if (r1==JAMAICA_NULL) { goto l4; }
 n0=((r1!=JAMAICA_NULL) && ((JAMAICA_BLOCK_GET_R(r1,1) == jam_class_javax_xml_namespace_QName_1)?TRUE:(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r1,1),4) == JAMAICA_NULL)?FALSE:(jam_class_javax_xml_namespace_QName_1 == JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r1,1),4),2))));
 if (n0!=0) { goto l5; }
l4:
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_javax_xml_namespace_QName_1_hashCode6(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 ...
 if (r1==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_java_lang_String_134_hashCode40;
ct->calledMethod=m;
