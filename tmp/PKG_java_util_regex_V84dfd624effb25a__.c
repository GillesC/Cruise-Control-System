...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_regex_Matcher_2_reset4(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r3=JAMAICA_NULL,r4=JAMAICA_NULL,r5=JAMAICA_NULL,r6=JAMAICA_NULL;
 jamaica_int32 n10=0,n5=0,n7=0,n8=0;
 jamaica_ref b2=JAMAICA_NULL,b4=JAMAICA_NULL;
...
l2:
 ...
 JAMAICA_BLOCK_GET_DATA32(b4,5).i = (-1);
 JAMAICA_BLOCK_GET_DATA32(b4,6).i = 0;
 JAMAICA_BLOCK_GET_DATA32(b4,7).i = (-1);
 n10=0;
 r5=r0;
 n5=0;
 n8=0;
 n7=0;
 r3=JAMAICA_BLOCK_GET_DATA32(r5,4).r;
 if (r3==JAMAICA_NULL) { goto l4; }
 n5=JAMAICA_BLOCK_GET_DATA32(r3,3).i;
 n5=((n5>>4) &  ((jamaica_int32)268435455));
l4:
 r6=r0;
 r4=JAMAICA_BLOCK_GET_DATA32(r6,4).r;
...
l7:
 ...
 JAMAICA_SET_ARRAY32_D0(r4,n10,(-1));
...
{jamaica_ref new_ref=r5;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 r3=JAMAICA_BLOCK_GET_DATA32(b4,1).r;
...
l15:
 ...
 r0=JAMAICA_BLOCK_GET_DATA32(b2,1).r;
...
{l[0]=JAMAICA_NULL;}
 ...
 goto l17;
l20:
 JAMAICA_BLOCK_GET_DATA32(b4,0).i = 0;
 JAMAICA_BLOCK_GET_DATA32(r5,5).i = 0;
{ jamaica_ref m=jam_mtd_java_util_regex_Matcher_2_getTeength32;
ct->calledMethod=m;
 n10=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r5);
}
 JAMAICA_BLOCK_GET_DATA32(r5,6).i = n10;
...
JBIEXPORT jamaica_ref JBICALL jam_comp_java_util_regex_Matcher_2_group11(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL;
 jamaica_int32 n2=0,n3=0,n1=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+6;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_java_util_regex_Matcher_2_group11;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
{jamaica_ref new_ref=r0;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[0]=new_ref;}
 ...
 jamaicaScheduler_syncPointFull(ct);
l2:
 if (JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r0,7).r,5).i>=0) { goto l4; }
...
ct->calledMethod=m;
 ((void(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,jam_str_java_util_regex_Matcher_241);
}
...
l4:
 n1=n0;
 if (n1<0) { goto l6; }
{ jamaica_ref m=jam_mtd_java_util_regex_Matcher_2_groupCount12;
ct->calledMethod=m;
 n2=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r0);
}
 if (n1<=n2) { goto l7; }
l6:
...
{l[1]=JAMAICA_NULL;}
 ...
 r1=jam_comp_java_lang_Strinilder_140_append4(ct,r1,jam_str_java_util_regex_Matcher_235);
...
l7:
 ...
 n1=(n1&15);
 JAMAICA_GET_ARRAY32(r1,n0,n3);
 if (n3==(-1)) { goto l9; }
 n0=JAMAICA_ADDS32(n0,1);
 if (((jamaica_uint32)(n0))>=((jamaica_uint32)(n2))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_ARRAY32(r1,n0,n0);
 if (n0!=(-1)) { goto l10; }
l9:
...
{ jamaica_ref m=jam_mtd_java_util_regex_Matcher_2_getSuuence33;
ct->calledMethod=m;
 r0=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r0,n3,n0);
}
 if (r0==JAMAICA_NULL) { goto LABEL_tNPE; }
 r1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r0,1),3).r;
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_lang_Object_92_toString7,1).i>>20) &  ((jamaica_int32)4095));
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_Matcher_2_search30(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n5) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r4=JAMAICA_NULL,r2=JAMAICA_NULL,r3=JAMAICA_NULL,r5=JAMAICA_NULL;
 jamaica_int32 n6=0,n0=0,n2=0,n3=0;
...
l2:
 ...
 JAMAICA_BLOCK_GET_DATA32(b0,2).b[0] = (jamaica_int8) 0;
 JAMAICA_BLOCK_GET_DATA32(b0,2).b[1] = (jamaica_int8) 0;
 if (n5>=0) { goto l4; }
 n6=0;
 goto l5;
l4:
...
l5:
 ...
 JAMAICA_BLOCK_GET_DATA32(b0,5).i = n6;
 n6=JAMAICA_BLOCK_GET_DATA32(b0,7).i;
 r4=r3;
 if (n6>=0) { goto l7; }
 n6=n5;
 goto l8;
...
l8:
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,7).i = n6;
 n6=0;
 r3=r0;
...
l10:
 r5=r0;
 r2=JAMAICA_BLOCK_GET_DATA32(r5,4).r;
...
l15:
 ...
 n6=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patte4Node_67_match1,1).i>>20) &  ((jamaica_int32)4095));
 n0=(JAMAICA_BLOCK_GET_DATA32(r5,3).i&15);
 JAMAICA_GET_REF_ARRAY(r5,n6,r5);
{ jamaica_ref m=r5;
ct->calledMethod=m;
 n5=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r4,r3,n5,r2);
}
 n6=n5;
 if (n5!=0) { goto l17; }
...
{l[0]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(b0,7).i = JAMAICA_BLOCK_GET_DATA32(b0,6).i;
 ct->m.cli-=3;
 return n6;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_Matcher_2_match31(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n5,jamaica_int32 n6) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r4=JAMAICA_NULL,r2=JAMAICA_NULL,r3=JAMAICA_NULL,r5=JAMAICA_NULL;
 jamaica_int32 n7=0,n0=0,n2=0,n3=0;
 jamaica_ref b0=JAMAICA_NULL;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+3;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
...
l5:
 ...
 r3=r0;
 b0=JAMAICA_BLOCK_GET_DATA32(r3,7).r;
 JAMAICA_BLOCK_GET_DATA32(b0,5).i = n7;
 n7=JAMAICA_BLOCK_GET_DATA32(b0,7).i;
 r4=r3;
 if (n7>=0) { goto l7; }
 n7=n5;
 goto l8;
...
l8:
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,7).i = n7;
 n7=0;
 r3=r0;
...
l15:
 b0=JAMAICA_BLOCK_GET_DATA32(r3,7).r;
 JAMAICA_BLOCK_GET_DATA32(b0,4).i = n6;
 r4=JAMAICA_BLOCK_GET_DATA32(r3,3).r;
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 r4=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r4,7).r,3).r;
 r2=JAMAICA_BLOCK_GET_DATA32(b0,3).r;
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 r5=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r4,1),3).r;
 n7=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patte4Node_67_match1,1).i>>20) &  ((jamaica_int32)4095));
 n0=(JAMAICA_BLOCK_GET_DATA32(r5,3).i&15);
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_Patteperty_18_match1(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 r3=r1;
 if (r3==JAMAICA_NULL) { goto LABEL_tNPE; }
 if (n0>=JAMAICA_BLOCK_GET_DATA32(r3,6).i) { goto l8; }
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jamaicaInterpreter_getInterfaceMethod(ct,r2,jam_mtd_java_lang_CharSuence_11_charAt1);
ct->calledMethod=m;
 if(m == JAMAICA_NULL) jamaica_throwIncompClassChangeErr(ct);
 if(JAMAICA_BLOCK_GET_I(m,1) & 1024 )jamaica_throwAbstrMethodErr(ct);
 n1=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,r2,n0);
}
 r3=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r0,1),3).r;
 n2=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patteperty_27_isSatiedBy1,1).i>>20) &  ((jamaica_int32)4095));
...
{l[2]=JAMAICA_NULL;}
 ...
 n1=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patte4Node_67_match1,1).i>>20) &  ((jamaica_int32)4095));
...
{ jamaica_ref m=r0;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3,r1,JAMAICA_ADDS32(n0,1),r2);
}
 if (n0==0) { goto l6; }
 n0=1;
 goto l7;
...
{l[0]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r3,7).r,1).r,2).b[0] = (jamaica_int8) 1;
 ct->m.cli-=3;
 return 0;
LABEL_tNPE:    jamaica_throwNullPtrExc(ct);         return 0;
LABEL_tSOE:    jamaica_throwStackOvrflwErr(ct);     return 0;
}
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_Patteranch_22_match2(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r3=JAMAICA_NULL,r4=JAMAICA_NULL,r5=JAMAICA_NULL,r6=JAMAICA_NULL,r7=JAMAICA_NULL,r8=JAMAICA_NULL;
...
l3:
 if (n1>=JAMAICA_BLOCK_GET_DATA32(r3,5).i) { goto l11; }
 r7=JAMAICA_BLOCK_GET_DATA32(r4,4).r;
 n3=n1;
 ...
 r7=JAMAICA_BLOCK_GET_DATA32(r0,6).r;
 if (r7==JAMAICA_NULL) { goto LABEL_tNPE; }
 r7=JAMAICA_BLOCK_GET_DATA32(r7,3).r;
 if (r7==JAMAICA_NULL) { goto LABEL_tNPE; }
 r8=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r7,1),3).r;
 n3=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patte4Node_67_match1,1).i>>20) &  ((jamaica_int32)4095));
 n4=(JAMAICA_BLOCK_GET_DATA32(r8,3).i&15);
 JAMAICA_GET_REF_ARRAY(r8,n3,r8);
{ jamaica_ref m=r8;
ct->calledMethod=m;
 n3=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r7,r5,n2,r6);
}
 if (n3==0) { goto l9; }
...
{ jamaica_ref m=r8;
ct->calledMethod=m;
 n3=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r7,r1,n0,r2);
}
 if (n3==0) { goto l9; }
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_PattepHead_60_match1(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r3=JAMAICA_NULL,r4=JAMAICA_NULL;
 jamaica_int32 n4=0,n1=0,n2=0,n3=0;
 jamaica_ref b0=JAMAICA_NULL;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+3;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
...
l2:
 ...
 n3=(n2&15);
 JAMAICA_GET_ARRAY32(r3,n1,n4);
 JAMAICA_SET_ARRAY32(r3,n1,n0);
 r3=JAMAICA_BLOCK_GET_DATA32(r0,3).r;
 if (r3==JAMAICA_NULL) { goto LABEL_tNPE; }
...
{ jamaica_ref m=r4;
ct->calledMethod=m;
 n1=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3,r1,n0,r2);
}
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_PattepTail_61_match1(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n0,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r3=JAMAICA_NULL,r4=JAMAICA_NULL;
 jamaica_int32 n5=0,n7=0,n1=0,n2=0,n3=0,n4=0,n6=0;
 jamaica_ref b0=JAMAICA_NULL;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+3;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
...
l2:
 ...
 n3=(n3&15);
 JAMAICA_GET_ARRAY32(r3,n1,n5);
 n6=JAMAICA_ADDS32(n1,1);
 if (((jamaica_uint32)(n6))>=((jamaica_uint32)(n4))) { goto LABEL_tAIOOBE; }
 JAMAICA_GET_ARRAY32(r3,n6,n7);
 JAMAICA_SET_ARRAY32(r3,n1,n2);
 JAMAICA_SET_ARRAY32(r3,n6,n0);
 r3=JAMAICA_BLOCK_GET_DATA32(r0,3).r;
 if (r3==JAMAICA_NULL) { goto LABEL_tNPE; }
 r4=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r3,1),3).r;
 n1=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_java_util_regex_Patte4Node_67_match1,1).i>>20) &  ((jamaica_int32)4095));
...
{l[0]=JAMAICA_NULL;}
 ...
 r1=JAMAICA_BLOCK_GET_DATA32(r1,4).r;
...
{l[1]=JAMAICA_NULL;}
 ...
 n2=(n2&15);
 JAMAICA_SET_ARRAY32(r1,n1,n5);
 n1=JAMAICA_ADDS32(n1,1);
 if (((jamaica_uint32)(n1))>=((jamaica_uint32)(n3))) { goto LABEL_tAIOOBE; }
 JAMAICA_SET_ARRAY32(r1,n1,n7);
 ct->m.cli-=3;
 return 0;
l6:
...
{l[0]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(b0,6).i = n0;
 ct->m.cli-=3;
 return 1;
LABEL_tAIOOBE: jamaica_throwArrIdxOutOfBndsExc(ct); return 0;
LABEL_tNPE:    jamaica_throwNullPtrExc(ct);         return 0;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_Patteingle_73_isSatiedBy1(jamaica_thread *ct,jamaica_ref r0,jamaica_int32 n0) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 if (n0!=JAMAICA_BLOCK_GET_DATA32(r0,4).i) { goto l4; }
 n0=1;
 goto l5;
l4:
 n0=0;
...
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_regex_PatteStart_84_match1(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_int32 n1,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 ...
 r3=r0;
 n3=JAMAICA_BLOCK_GET_DATA32(r3,4).i;
...
{l[0]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(r1,7).r,1).r,2).b[0] = (jamaica_int8) 1;
 ct->m.cli-=4;
 return 0;
l4:
 n3=0;
...
{ jamaica_ref m=r5;
ct->calledMethod=m;
 n5=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int32,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r4,r3,n4,r2);
}
 n3=n5;
 if (n5!=0) { goto l18; }
 if (n4!=n2) { goto l10; }
 JAMAICA_BLOCK_GET_DATA32(b0,2).b[0] = (jamaica_int8) 1;
l10:
 n1=JAMAICA_ADDS32(n1,1);
...
{l[1]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(b0,5).i = n1;
 r3=JAMAICA_BLOCK_GET_DATA32(r1,4).r;
