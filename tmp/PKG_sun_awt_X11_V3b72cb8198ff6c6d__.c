...
JBIEXPORT jamaica_ref JBICALL jam_comp_sun_awt_X11_XGlobnager_114_getCaursor12(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 ...
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_sun_awt_X11_XGlobnager_114_getCaursor12;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
{jamaica_ref new_ref=r3;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[2]=new_ref;}
 ...
 if (((r3!=JAMAICA_NULL) && ((JAMAICA_BLOCK_GET_R(r3,1) == jam_class_java_awt_Window_200)?TRUE:((JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4) == JAMAICA_NULL) || (JAMAICA_BLOCK_GET_I(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4),1)<=2))?FALSE:(jam_class_java_awt_Window_200 == JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4),4))))!=0) { goto l10; }
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_isEnadImpl17;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3);
}
 if (n0==0) { goto l10; }
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_getVisible16;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3);
}
 if (n0==0) { goto l10; }
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_getPeer13;
ct->calledMethod=m;
...
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_getPatCode9;
ct->calledMethod=m;
 r2=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3);
}
...
{l[2]=JAMAICA_NULL;}
 ...
 r3=r2;
 if (((r3!=JAMAICA_NULL) && ((JAMAICA_BLOCK_GET_R(r3,1) == jam_class_java_awt_Window_200)?TRUE:((JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4) == JAMAICA_NULL) || (JAMAICA_BLOCK_GET_I(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4),1)<=2))?FALSE:(jam_class_java_awt_Window_200 == JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(JAMAICA_BLOCK_GET_R(r3,1),4),4))))==0) { goto l18; }
...
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_getCutCode18;
ct->calledMethod=m;
...
{l[0]=JAMAICA_NULL;}
 ...
 n0=JAMAICA_BLOCK_GET_DATA32(jam_class_java_awt_Cursor_56,5).i;
 if (((n0>>20) |  ((n0>=0)?0:(jamaica_int32)(-4096)))!=6) {
  jamaicaInterpreter_initialize_class_helper(ct,jam_class_java_awt_Cursor_56,-1);
 }
{ jamaica_ref m=jam_mtd_java_awt_Cursor_56_getPrursor3;
ct->calledMethod=m;
 r1=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_int32))JAMAICA_BLOCK_GET_P(m,4))(ct,0);
}
l17:
 ct->f=ct->s[tp-4];
...
{ jamaica_ref m=jam_mtd_sun_awt_Compoessor_11_getPatCode9;
ct->calledMethod=m;
 r1=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r3);
}
...
{l[3]=JAMAICA_NULL;}
 ...
 r1=jam_comp_sun_awt_X11_XGlobnager_114_getCaursor12(ct,r0,r1);
 ct->f=ct->s[tp-4];
 ct->m.cl[tp-2]=JAMAICA_NULL;
 ct->m.cli=tp-8;
 return r1;
