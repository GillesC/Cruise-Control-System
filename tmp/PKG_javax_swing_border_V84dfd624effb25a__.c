...
JBIEXPORT jamaica_ref JBICALL jam_comp_javax_swing_border_Abstrorder_0_getBonsets2(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r2=JAMAICA_NULL,r3=JAMAICA_NULL;
 jamaica_int32 n1=0,n2=0,n3=0,n0=0;
 JAMAICA_C_STACK_OVERFLOW(ct, goto LABEL_tSOE;);
 tp=ct->m.cli+6;
 if(tp > ct->javaStackSize) { goto LABEL_tSOE; }
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_javax_swing_border_Abstrorder_0_getBonsets2;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
l2:
 n0=JAMAICA_BLOCK_GET_DATA32(jam_class_java_awt_Insets_124,5).i;
 if (((n0>>20) |  ((n0>=0)?0:(jamaica_int32)(-4096)))!=6) {
  jamaicaInterpreter_initialize_class_helper(ct,jam_class_java_awt_Insets_124,-1);
 }
 if (ct->plainAlloc) {
  r2 = jamaicaGC_PlainAllocHeadBlock(ct,2);
  if (r2 != JAMAICA_NULL) {
   JAMAICA_BLOCK_GET_R(r2,1)=jam_class_java_awt_Insets_124;
  }
 } else {
 r2=jamaicaInterpreter_allocJavaObject(ct,jam_class_java_awt_Insets_124);
 }
 ...
 JAMAICA_BLOCK_GET_DATA32(r2,4).i = n1;
 JAMAICA_BLOCK_GET_DATA32(r2,5).i = n2;
 JAMAICA_BLOCK_GET_DATA32(r2,6).i = n3;
 r3=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_R(r0,1),3).r;
 n0=((JAMAICA_BLOCK_GET_DATA32(jam_mtd_javax_swing_border_Abstrorder_0_getBonsets3,1).i>>20) &  ((jamaica_int32)4095));
...
JBIEXPORT jamaica_ref JBICALL jam_comp_javax_swing_border_Compoorder_3_getBonsets3(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 ...
 ct->s[tp-4]=ct->f;ct->f=tp-4;
 ct->s[tp-3]=0;
 {jamaica_ref m=jam_mtd_javax_swing_border_Compoorder_3_getBonsets3;ct->s[tp-2]=(jamaica_int32)m;ct->m.cl[tp-2]=m;}
 ct->m.cli=tp;
...
{jamaica_ref new_ref=r3;if(new_ref!=JAMAICA_NULL)if(JAMAICA_BLOCK_GET_R(new_ref,0)==gc->white){ JAMAICA_BLOCK_GET_R(new_ref,0)=gc->greyList;gc->greyList=new_ref;}l[1]=new_ref;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r3,6).i = 0;
 JAMAICA_BLOCK_GET_DATA32(r3,4).i = 0;
 JAMAICA_BLOCK_GET_DATA32(r3,3).i = 0;
 r4=r0;
 r4=JAMAICA_BLOCK_GET_DATA32(r4,3).r;
 if (r4==JAMAICA_NULL) { goto l4; }
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jamaicaInterpreter_getInterfaceMethod(ct,r4,jam_mtd_javax_swing_border_Border_2_getBonsets1);
ct->calledMethod=m;
 if(m == JAMAICA_NULL) jamaica_throwIncompClassChangeErr(ct);
 if(JAMAICA_BLOCK_GET_I(m,1) & 1024 )jamaica_throwAbstrMethodErr(ct);
 r4=((jamaica_ref(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref))JAMAICA_BLOCK_GET_P(m,4))(ct,r4,r1);
}
 if (r4==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_BLOCK_GET_DATA32(r3,3).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r3,3).i,JAMAICA_BLOCK_GET_DATA32(r4,3).i);
 JAMAICA_BLOCK_GET_DATA32(r3,4).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r3,4).i,JAMAICA_BLOCK_GET_DATA32(r4,4).i);
 JAMAICA_BLOCK_GET_DATA32(r3,6).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r3,6).i,JAMAICA_BLOCK_GET_DATA32(r4,6).i);
...
{l[1]=JAMAICA_NULL;}
 ...
 JAMAICA_BLOCK_GET_DATA32(r3,5).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r3,5).i,JAMAICA_BLOCK_GET_DATA32(r4,5).i);
l4:
...
{ jamaica_ref m=jamaicaInterpreter_getInterfaceMethod(ct,r3,jam_mtd_javax_swing_border_Border_2_getBonsets1);
ct->calledMethod=m;
 if(m == JAMAICA_NULL) jamaica_throwIncompClassChangeErr(ct);
 if(JAMAICA_BLOCK_GET_I(m,1) & 1024 )jamaica_throwAbstrMethodErr(ct);
 ...
 if (r3==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_BLOCK_GET_DATA32(r2,3).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r2,3).i,JAMAICA_BLOCK_GET_DATA32(r3,3).i);
 JAMAICA_BLOCK_GET_DATA32(r2,4).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r2,4).i,JAMAICA_BLOCK_GET_DATA32(r3,4).i);
 JAMAICA_BLOCK_GET_DATA32(r2,6).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r2,6).i,JAMAICA_BLOCK_GET_DATA32(r3,6).i);
 JAMAICA_BLOCK_GET_DATA32(r2,5).i = JAMAICA_ADDS32(JAMAICA_BLOCK_GET_DATA32(r2,5).i,JAMAICA_BLOCK_GET_DATA32(r3,5).i);
l6:
...
JBIEXPORT jamaica_ref JBICALL jam_comp_javax_swing_border_Emptyorder_4_getBonsets2(jamaica_thread *ct,jamaica_ref r0,jamaica_ref r1,jamaica_ref r2) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
...
l2:
 if (r2==JAMAICA_NULL) { goto LABEL_tNPE; }
 JAMAICA_BLOCK_GET_DATA32(r2,4).i = JAMAICA_BLOCK_GET_DATA32(r0,3).i;
 JAMAICA_BLOCK_GET_DATA32(r2,3).i = JAMAICA_BLOCK_GET_DATA32(r0,5).i;
 JAMAICA_BLOCK_GET_DATA32(r2,6).i = JAMAICA_BLOCK_GET_DATA32(r0,4).i;
 JAMAICA_BLOCK_GET_DATA32(r2,5).i = JAMAICA_BLOCK_GET_DATA32(r0,6).i;
 ct->m.cli-=2;
 return r2;
LABEL_tNPE:    jamaica_throwNullPtrExc(ct);         return JAMAICA_NULL;
LABEL_tSOE:    jamaica_throwStackOvrflwErr(ct);     return JAMAICA_NULL;
