...
JBIEXPORT jamaica_int64 JBICALL jam_comp_java_util_concurrent_atomic_AtomicLong_2_get3(jamaica_thread *ct,jamaica_ref r0) {
 jamaica_int32 tp;
...
l2:
 j0=JAMAICA_BLOCK_GET_DATA64(r0,4).l;
 ct->m.cli-=1;
 return j0;
LABEL_tSOE:    jamaica_throwStackOvrflwErr(ct);     return JAMAICA_INT64_CONST_0;
}
JBIEXPORT jamaica_int32 JBICALL jam_comp_java_util_concurrent_atomic_AtomicLong_2_compandSet5(jamaica_thread *ct,jamaica_ref r0,jamaica_int64 j0,jamaica_int64 j1) {
 jamaica_int32 tp;
 jamaica_GCEnv *gc = ct->m.gcenv;
 jamaica_ref *l=&(ct->m.cl[ct->m.cli]);
 jamaica_ref r1=JAMAICA_NULL;
 jamaica_int32 n0=0;
 jamaica_int64 j2=JAMAICA_INT64_CONST_0;
...
l2:
 r1=JAMAICA_BLOCK_GET_DATA32(JAMAICA_BLOCK_GET_DATA32(jam_fld_java_util_concurrent_atomic_AtomicLong_2_unsafe1,7).r,4).r;
 j2=JAMAICA_BLOCK_GET_DATA64(jam_fld_java_util_concurrent_atomic_AtomicLong_2_valueffset2,4).l;
 if (r1==JAMAICA_NULL) { goto LABEL_tNPE; }
{ jamaica_ref m=jam_mtd_sun_misc_Unsafe_98_compapLong72;
ct->calledMethod=m;
 n0=((jamaica_int32(JBICALL *)(jamaica_thread *,jamaica_ref,jamaica_ref,jamaica_int64,jamaica_int64,jamaica_int64))JAMAICA_BLOCK_GET_P(m,4))(ct,r1,r0,j2,j0,j1);
}
 ct->m.cli-=1;
 return n0;
